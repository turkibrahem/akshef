...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img class="img2" src="img/cancermain.jpg" alt="صحتــك أولويتــك بالحيــــاة" width="1200" height="700">
...
<div class="form-group"clas="col-sm-12">
      ...
      <p style="direction:rtl; color:#989898; font-family:Droid Sans Arabic ;line-height:2; font-size:18px; text-align:justify ;text-justify: inter-word;"  class="col-sm-12"  class="pull-right">{{$dis->content}}</p>
</div>
      @endforeach
      @else
