<div class="container-fluid text-center" id="lists" style="font-family:Droid Sans Arabic;">
      
      <div class="col-sm-1" id="lists1"></div>
      <div class="col-sm-2" id="lists1">
        
                <ul>
                    <li id="point">سياســات اكــشـــف</li>
                    <li><h5><a href="rule" >شروط الاستخدام</a></h5></li>
                    <li><h5><a href="policy" >سياسات المقالات</a></h5></li>
                    <li><h5><a href="QA" >سياسات الاسئلة و الأجوبة</a></h5></li>
                    <li><h5><a href="privacy" >سياسات الخصوصية</a></h5></li>
      ...
      <div class="col-sm-2" id="lists1">
                ...
                <ul>
                    <li id="point">الاطبـــــــــاء</li>
                    <li><h5><a href="doctors" > أطبــاء أمراض الأسنان</a></h5></li>
                    <li><h5><a href="doctors" >أطبـــاء أمراض الرمد</a></h5></li>
                    <li><h5><a href="doctors" > أطبـاء أمراض القــلب</a></h5></li>
                    <li><h5><a href="doctors" >أطبـاء أمراض العظــام</a></h5></li>
                    <li><h5><a href="doctors" >أطبـــاء الاورام </a></h5></li>
            ...
            <div class="col-sm-2" id="lists1">
                ...
                <ul>
                    <li id="point">الامـــــــــــراض</li>
                    <li><h5><a href="teeth" > أمــراض الأسنــــان</a></h5</li>
                    <li><h5><a href="eyes">أمـــراض الرمـــد</a></h5></li>
                    <li><h5><a href="heart"> أمــــراض القلــــب</a></h5></li>
                    <li><h5><a href="bones">أمــــراض العظــــام</a></h5></li>
                    <li><h5><a href="cancer">أمـــــراض السرطــــان</a> </h5></li>
      ...
      <div class="col-sm-2" id="lists1">
                ...
                <ul>
                    <li id="point">معلومات صحية</li>
                    <li><h5><a href="workout">تمارين رياضية</a></h5></li>
                    <li><h5><a href="smooking">الاقلاع عن التدخين</a></h5></li>
                    <li><h5><a href="eyeshealth">صحة عيونك</a></h5></li>
                    <li><h5><a href="teethbeauty">جمال أسنانك</a></h5></li>
                    <li><h5><a href="strongbones">عظام أقوي </a></h5></li>
                    <li><h5><a href="food">أنظمة غذائية صحية</a></h5></li>
      ...
      <div class="col-sm-2" id="lists1">
                ...
                <ul>
                    <li id="point">الصفحة الرئيسيـة</li>
                    <li><h5><a href="about">عن الموقـــع</a></h5></li>
                    <li><h5><a href="#services1">خدماتنـــا</a></h5></li>
                    <li><h5><a href="team">فريــق الموقـــع</a></h5></li>
                    <li><h5><a href="callus">اتصل بنــا</a></h5></li>
                    <li><h5><a href="about">للمزيـــد </a></h5></li>
                    <li><h5><a href="callus">للتواصل معنا</a></h5></li>
  ...
  <div class="container-fluid" id="circle">
  ...
  <!--------------------------------------------------------------Copyright------------------------------------------------------------------->
     ...
     <div class="container-fluid" style="width:100% !important; padding:0;">
        <footer class="footer-distributed" style="width:100% !important;">
            <div class="footer-right">
                <p class="footer-links">
                  <p class="copy">جميع الحقوق محفوظة لموقع اكشف &copy; 2018</p>
                </div>
